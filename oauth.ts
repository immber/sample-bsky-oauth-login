...
const localhost = `http://127.0.0.1:${process.env.PORT}`;
...
export const client = new NodeOAuthClient({
    ...
    clientMetadata: {
        ...
        client_id: `${localhost}/client-metadata.json`,
        client_uri: localhost,
        redirect_uris: [`${localhost}/bsky-oauth-callback`],
